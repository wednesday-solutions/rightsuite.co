...
My target buyer: [job title, company type, company size - use output from Prompt 01 if you've run it]
...
- Take the "one-sentence reframe" and test it as your hero headline - run it through [Prompt 04 (Copy Scorecard)](./04-copy-scorecard.md)
- Use the "gap nobody owns" as the framing for your cold outreach - run it through [Prompt 05 (Cold Outreach Diagnostic)](./05-cold-outreach-diagnostic.md)
