---
layout: default
title: Vibe Coders & Indie Hackers
parent: Use Cases
nav_order: 4
...
**Start with the free prompts.** [Prompt 01 - ICP Validation]({{ '/prompts/01-icp-validation' | relative_url }}) takes 2 minutes and any AI model. Paste in your product description and the 2-3 buyer types you're considering. You'll get a ranked read on which segment has the most urgent need for what you built. [Prompt 03 - Price Sensitivity]({{ '/prompts/03-price-sensitivity' | relative_url }}) gives you a willingness-to-pay estimate for your segment before you put a number on your pricing page. [Prompt 04 - Copy Scorecard]({{ '/prompts/04-copy-scorecard' | relative_url }}) tells you if your landing page would convert a cold visitor or lose them.

**Use the templates for structure.** The [ICP Scoring Matrix]({{ '/templates/icp-scoring-matrix' | relative_url }}) gives you a decision framework for choosing a segment when the prompt output leaves you with two equally good options. The [Landing Page Copy Formula]({{ '/templates/landing-page-copy-formula' | relative_url }}) is a fill-in-the-blank structure that produces a working first draft in under 30 minutes.
...
[Start validating](https://www.rightsuite.co?utm_source=docs&utm_medium=referral&utm_campaign=docs&utm_content=usecase-indie-hackers){: .btn .btn-green }
