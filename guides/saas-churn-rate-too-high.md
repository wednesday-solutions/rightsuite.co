---
layout: default
title: Why Your SaaS Churn Rate Is Too High
parent: Guides
description: "Acceptable SaaS churn is 5-7% annually for SMB, under 2% for enterprise. If you're above that, here's how to find out whether it's a product problem, a segment problem, or a promise problem."
faq:
  - q: "What is an acceptable churn rate for SaaS?"
    a: "Acceptable annual churn is 5-7% for SMB SaaS and under 2% for enterprise SaaS. Monthly, that translates to 0.4-0.6% for SMB and under 0.17% for enterprise. If you're measuring monthly churn and it's above 2%, you have a significant problem - at 2% monthly churn, you lose 22% of your customer base every year. The right benchmark depends on your segment: enterprise contracts are longer and switching costs are higher, so the standard is stricter."
  - q: "How do I reduce SaaS churn?"
    a: "Start by segmenting your churn into early churn (first 60 days) and late churn (6+ months). Early churn is almost always an ICP or onboarding problem - customers who cancel in the first 60 days usually never reached the core value of your product. Late churn is usually a value-delivery or competitive problem - customers who got value but stopped getting it, or found a better alternative. Treating both the same way is why most churn reduction efforts fail."
...
1. **Are churned customers from the same segment as retained customers?** Pull a list of your churned customers and your retained customers. Compare company size, industry, role of the buyer, and how they found you. If churned customers cluster in a specific segment, that's a fit problem, not a product problem.
...
Diagnosing whether your churn is a segment problem or an onboarding problem requires knowing exactly who your best customers are - and what they have in common. [RightAudience]({{ '/docs/products/right-audience/' | relative_url }}) maps the characteristics of your retained customers so you can tighten your ICP before the next cohort signs up. [RightMessaging]({{ '/docs/products/right-messaging/' | relative_url }}) checks whether your onboarding sets the expectations that your product actually delivers on.

[Diagnose your segment fit](https://www.rightsuite.co/products/right-audience?utm_source=docs&utm_medium=referral&utm_campaign=docs&utm_content=guide-saas-churn-rate-too-high){: .btn .btn-green }
