---
layout: default
title: How to Price a New SaaS Product From Scratch
parent: Guides
description: "The average SaaS company spends 8 hours total on pricing and picks a round number that feels right. Here's a 4-step method that doesn't rely on gut feel."
faq:
  - q: "What should I charge for a new SaaS product?"
    a: "The B2B SaaS median is $150-300 per month, but that number is useless without knowing your buyer's alternatives. Start by asking what your target buyer currently pays - in money or time - to solve the problem you're solving. Anchor to that number first. Then run price sensitivity research to find the range where your price feels like fair value rather than too cheap or too expensive. A price inside that range will outperform any round number you pick by feel."
  - q: "How do I find the right price range for my SaaS?"
    a: "The Van Westendorp Price Sensitivity Meter is the most direct method. Ask four questions to real or simulated buyers: at what price is this so cheap you'd question its quality? At what price is it a bargain? At what price is it getting expensive but still worth it? At what price is it too expensive? The intersection of those curves gives you a range with a lower bound, an upper bound, and a point of maximum acceptability. Your price should sit between the lower and upper bounds."
  - q: "Should I price low at first and raise prices later?"
    a: "Only if you have a specific plan to raise prices and evidence that your early customers are the right buyers. Products priced too low convert at the same rate as products priced correctly - but generate 40-60% less revenue per account. Worse, a price that's too low attracts buyers who are selecting on cost, not on value - and those buyers churn faster. Start inside your validated range, not below it."
---
...
Running Van Westendorp with enough buyers to get statistically meaningful results takes time most early-stage founders don't have. [RightPrice]({{ '/docs/products/right-price/' | relative_url }}) runs price sensitivity across 100+ synthetic buyers in your target segment and returns your optimal price range, a confidence score, and a trial strategy recommendation - in hours rather than weeks.

[Find your optimal price range with RightPrice](https://www.rightsuite.co/products/right-price?utm_source=docs&utm_medium=referral&utm_campaign=docs&utm_content=guide-how-to-price-a-new-saas-product){: .btn .btn-green }

---

Related: [B2B SaaS Pricing Models Explained]({{ '/guides/b2b-saas-pricing-models/' | relative_url }}) - [How to Know If You're Undercharging for Your SaaS]({{ '/guides/am-i-undercharging-for-my-saas/' | relative_url }}) - [Price Sensitivity Analysis for SaaS]({{ '/guides/price-sensitivity-analysis-saas/' | relative_url }})
