---
layout: guide
title: When Should You Raise Your SaaS Prices
parent: Guides
nav_order: 1
description: Most SaaS founders wait too long to raise prices. Learn the signals that tell you you're ready, and how to raise without losing the customers you have.
faqs:
  - question: When is the right time to raise SaaS prices?
    answer: The right time is when demand clearly exceeds supply — specifically, when your inbound close rate is above 30%, customers are describing you as "great value" or "surprisingly affordable," and your NPS is above 40. Those three signals together mean customers are getting more value than they're paying for. Waiting for a "perfect" moment means waiting forever. If you're growing feature depth and delivering more outcomes year over year but haven't touched your pricing in 18+ months, you're almost certainly underpriced.
  - question: How much should I raise my SaaS prices by?
    answer: A 10–20% increase on new customers is a safe starting point for a first raise. At that range, you're unlikely to see meaningful churn on new sign-ups, and you'll recover the revenue quickly enough to measure the impact. If you've been flat for more than two years while adding significant product value, a 20–40% increase is defensible. The test is whether your close rate changes — if it doesn't move, you've found room to go further.
  - question: Will I lose customers if I raise my SaaS prices?
    answer: If you raise for new customers only and grandfather existing customers at their current rate, churn impact is typically near zero. The customers who leave when prices increase are usually low-value, high-friction accounts anyway. The data consistently shows that price-sensitive customers have higher support costs, lower expansion revenue, and worse NPS scores than customers who pay a fair rate for the value they receive.
---
...
Knowing when to raise prices is one problem. Knowing exactly how much room you have — by segment, by plan, by customer type — is another. [RightPrice](https://www.rightsuite.co/products/right-price?utm_source=docs&utm_medium=referral&utm_campaign=docs&utm_content=guide-when-to-raise-saas-prices) analyzes your pricing signals against benchmarks from comparable SaaS companies so you can walk into a pricing decision with data instead of intuition.

[Explore RightPrice]({{ '/docs/products/right-price/' | relative_url }}){: .btn .btn-green }

---

**Related:** If you're not sure whether your current prices are already too low, start with [Am I Undercharging for My SaaS?](/guides/am-i-undercharging-for-my-saas/)
