---
layout: default
title: How to Know If You're Undercharging for Your SaaS
parent: Guides
description: "Most early-stage SaaS founders undercharge by 40-60%. Here are the signs, and how to raise prices without losing customers."
faq:
  - q: "How do I know if I'm charging too little for my SaaS?"
    a: "The clearest signals: prospects sign up without asking about pricing, customers describe your product as 'surprisingly cheap' or 'great value,' you're the lowest-priced option in your category, and you've never lost a deal because the price seemed too low or made you look unserious. If two or more of those are true, you're almost certainly leaving money on the table."
  - q: "What happens if I raise my SaaS prices?"
    a: "For most early-stage SaaS, a 20-40% price increase loses fewer customers than founders expect - typically 10-20% of the price-sensitive segment - while increasing revenue per account and attracting buyers with a stronger internal business case. The customers you lose at a higher price are usually the ones with the highest support burden and lowest retention anyway. The customers who stay are more committed."
  - q: "How much should I charge for a B2B SaaS product?"
    a: "There's no universal answer, but the Van Westendorp price sensitivity model gives you a data-backed range rather than a guess. The model identifies four price thresholds from buyer research: too cheap (damages credibility), acceptable lower bound, acceptable upper bound, and too expensive (creates friction). Your optimal price sits between the lower and upper bounds, weighted toward the upper end if your retention data is strong."
---
...
**1. Do prospects sign up without asking about pricing?**
If your conversion from pricing page to trial never generates a pricing objection, you may be priced below the threshold where buyers even register the cost as a real number. Friction at the right price level is a sign that buyers are taking the decision seriously. No friction at all often signals you're priced too low to be in consideration with serious buyers.

**2. Do customers say it's "great value" or "surprisingly cheap"?**
These phrases feel like compliments. They're signals that your price is below the buyer's expectation for what a product like this should cost. When buyers are surprised by how low your price is, you've left money on the table - and you've also signaled something about your product's tier that may be working against you in competitive evaluations.

**3. Are you the cheapest option in your category?**
Being the cheapest is a defensible position if it's intentional and tied to a clear segment story. If you're the cheapest by accident, you're likely attracting the most price-sensitive buyers in your market - the ones with the highest churn, the highest support load, and the lowest lifetime value.

**4. Have you ever lost a deal because the price was too low?**
...
The Van Westendorp model requires enough buyer conversations to be statistically meaningful - which takes time you may not have. [RightPrice]({{ '/docs/products/right-price/' | relative_url }}) runs 100+ synthetic buyer interactions against your current pricing, returning a confidence score, your optimal price range, and a trial strategy recommendation. It's the same methodology - with enough sample size to be actionable - in hours rather than weeks.

[Find your real price ceiling with RightPrice](https://www.rightsuite.co/products/right-price?utm_source=docs&utm_medium=referral&utm_campaign=docs&utm_content=guide-am-i-undercharging-for-my-saas){: .btn .btn-green }
