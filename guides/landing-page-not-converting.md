...
parent: Guides
description: "A landing page that doesn't convert has one of four problems: wrong headline, wrong audience, wrong offer, or wrong traffic. Here's how to tell them apart."
faq:
  - q: "Why is my landing page not converting?"
    a: "Almost always one of four root causes: the headline doesn't match the reader's problem, the traffic source doesn't match your ICP, the offer asks for too much commitment too early, or the social proof is from a different type of buyer than the one you're targeting. Identifying which one you have determines what you fix."
  - q: "How do I fix a landing page with low conversion?"
    a: "Diagnose before you fix. Look at where the drop-off happens: if bounce rate is high, it's a hero messaging or traffic-match problem. If people scroll but don't click, it's a CTA or offer problem. If people click but don't complete the form, it's a friction or trust problem. Each symptom points to a different fix."
