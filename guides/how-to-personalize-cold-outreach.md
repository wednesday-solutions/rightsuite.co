...
faqs:
  - question: "How do I personalize cold emails at scale?"
    answer: "The practical approach to personalized cold email at scale is a two-layer system: one individual-level observation as the opening line, followed by a segment-specific templated body. The opening line requires 2–3 minutes of research per prospect — reading a recent LinkedIn post, a company announcement, or a piece of content they published — and references something specific enough that the prospect knows you actually looked. The body of the email is templated but segment-specific: a different message for VPs of Marketing than for Heads of Sales, a different message for 50-person companies than for 500-person companies. This approach produces open rates 2–3x higher than fully templated outreach while requiring a fraction of the time of fully individualized outreach."
  - question: "What is a good personalization strategy for B2B outreach?"
    answer: "A good B2B personalization strategy operates at three levels simultaneously. First, define your audience segments before you write any email — group your prospect list by role, industry, company size, or pain point. Write a distinct templated body for each segment that references the specific problem or context that segment shares. Second, add an individual-level observation to the opening line of each email that proves you researched this specific person. Third, make your CTA specific to the segment's situation rather than generic — 'relevant given your team's recent expansion into enterprise accounts' converts better than 'relevant to your growth goals.' The test for whether your personalization is working: would the prospect assume you sent this to 500 people, or would they think you wrote it just for them?"
  - question: "How do I make cold outreach feel personal?"
    answer: "Cold outreach feels personal when it demonstrates specific knowledge of the prospect's situation — not just their name and company. The elements that create that feeling: an opening line that references something specific they said, wrote, or did (not just their job title), a description of their problem that's specific enough that they think 'how did they know that?', and a CTA that's calibrated to where they are in their decision-making process rather than where you'd like them to be. What breaks the feeling of personalization: merge tags that are obviously templated ('Hi {{first_name}}, I noticed you work at {{company}}'), references to information that's clearly pulled from a database rather than from actual research, and a value proposition that's so generic it could apply to any company in any industry."
---
...
1. **Does your opening line prove you read something about this specific person?** If your opening line could apply to any prospect on your list — a job title, a generic company description, a boilerplate reference to their industry — it isn't personalization. Personalization is specific: a post they published, a company news item, a specific responsibility mentioned in their LinkedIn bio.

2. **Can you batch your list into segments that share a common pain?** Segment-level personalization is the efficiency multiplier. If everyone on your list is a VP of Sales at a Series B company, you can write one highly specific body that resonates with all of them without writing 200 individual emails.

3. **Is your CTA calibrated to their level of awareness?** A prospect who has never heard of your product shouldn't receive a demo request as the first CTA. The right first ask matches where they are in their decision process — a relevant insight, a short video, a question — not where you'd like them to be.

4. **Are you measuring reply rate by segment?** If you're not splitting your outreach data by audience segment, you can't tell which message is working and which is wasting time.
...
[See how RightEngagement works](https://www.rightsuite.co/products/right-engagement?utm_source=docs&utm_medium=referral&utm_campaign=docs&utm_content=guide-how-to-personalize-cold-outreach){: .btn .btn-green }

---

**Related reading:**
- [RightEngagement — outreach attribution and sequencing]({{ '/docs/products/right-engagement/' | relative_url }})
- [Cold email that gets responses](/guides/cold-email-that-gets-responses/)
