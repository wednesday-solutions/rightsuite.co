...
<a href="{{ '/docs/products/right-positioning/' | relative_url }}" class="btn btn-green">Validate your positioning claim</a>

---

**Related reading:**
- [How to Write a Value Proposition for Your SaaS]({{ '/guides/how-to-write-value-proposition-saas/' | relative_url }})
- [Right Positioning — Positioning and Differentiation Validation]({{ '/docs/products/right-positioning/' | relative_url }})
