---
layout: default
title: How to Write a Positioning Statement for Your SaaS
parent: Guides
description: "A positioning statement isn't marketing copy. It's an internal compass that tells everyone on your team who you're for, who you're not for, and why you win."
faq:
  - q: "How do I write a positioning statement for a SaaS?"
    a: "Use the Geoffrey Moore template as your starting structure: 'For [target customer] who [has this problem], [Product name] is a [category] that [key benefit]. Unlike [competitor], [Product name] [key differentiator].' The template forces you to name a specific customer, a specific problem, and a specific competitor - three decisions that most SaaS companies avoid making explicitly. Write it as an internal document first. It's only useful externally once it's been committed to internally by your sales, marketing, and product teams."
  - q: "What is a positioning statement vs a value proposition?"
    a: "A positioning statement defines who you are for, who you are not for, and how you're different from the alternative. It's an internal strategic decision. A value proposition expresses what the customer gets - the outcome they receive from using your product. Your value proposition is derived from your positioning: once you know who you're for and why you win, you can write a value proposition that speaks directly to that buyer's situation. Positioning first, value proposition second."
...
1. **Can you name one segment you're explicitly not for?** If you can't name a buyer you would turn away, your positioning hasn't been committed to. Positioning is as much about exclusion as inclusion. The segment you're not for is what makes the segment you are for feel specifically served.

2. **Does your positioning name a competitor you reliably beat?** "Better than the alternatives" is not a positioning claim. "Better than [specific competitor] for [specific buyer in specific situation]" is. If your team can't name the competitor they beat most often and explain exactly why, your positioning isn't operational.

3. **Can your sales team recite your positioning in one sentence?** Ask three salespeople independently to describe who the product is for in one sentence. If you get three different answers, your positioning hasn't been internalized - it lives in a document, not in practice.

4. **Does your homepage reflect the positioning statement or contradict it?** Compare your positioning statement to your homepage headline, subheadline, and hero section. If a visitor who matches your ICP would have to work to figure out whether the product is for them, the positioning isn't reflected in the copy.
...
Positioning is a decision, not a description. It only becomes visible externally once it's been committed to internally. Once it's committed, it becomes the filter for every homepage word, every ad headline, every sales qualification question, and every product prioritization decision.
...
Writing a positioning statement your team will actually use requires knowing which customer segment you already win - not guessing. [RightPositioning]({{ '/docs/products/right-positioning/' | relative_url }}) maps your current customer data against market alternatives to show you where you have the strongest claim to differentiation, and which positioning choices will hold up when buyers compare you to the competition.

[Validate your positioning claim](https://www.rightsuite.co/products/right-positioning?utm_source=docs&utm_medium=referral&utm_campaign=docs&utm_content=guide-positioning-statement-for-saas){: .btn .btn-green }

---

Related: [How to Write a Value Proposition for Your SaaS]({{ '/guides/how-to-write-value-proposition-saas/' | relative_url }}) - [RightPositioning product page]({{ '/docs/products/right-positioning/' | relative_url }})
