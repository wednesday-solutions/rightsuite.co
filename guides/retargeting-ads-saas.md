...
faqs:
  - question: "How do retargeting ads work for SaaS?"
    answer: "Retargeting works by placing a pixel on your site that tracks visitors and lets you show ads to them on other platforms after they leave. When a visitor lands on your pricing page and leaves without signing up, a retargeting platform (Google, Meta, LinkedIn) can continue showing them ads as they browse elsewhere on the internet. For SaaS, the value is that these visitors already showed intent — they came to your site voluntarily, which means they're far more likely to convert than a cold audience seeing your ad for the first time. The key to retargeting for SaaS is segmentation: pricing page visitors, trial abandoners, blog readers, and homepage visitors all have different levels of intent, and showing them all the same ad wastes the signal you already have."
  - question: "Should I run retargeting ads for my SaaS?"
    answer: "Yes, if you have at least 1,000 monthly site visitors and a functional conversion funnel. Below 1,000 monthly visitors, your retargeting audience is too small for the platforms to optimize against — you'll spend budget on a pool that's too shallow to generate reliable data. Above that threshold, retargeting is typically the first paid channel early-stage SaaS founders should run because the audience is already warm, the CPCs are lower than cold acquisition, and the conversion rates are higher. The one condition is that your funnel has to work first. If organic visitors aren't converting at a reasonable rate, retargeting will drive more traffic into a broken funnel — it won't fix the funnel."
  - question: "How much should I spend on retargeting?"
    answer: "A practical starting budget for SaaS retargeting is $500–1,500 per month, sized to your traffic volume. As a rule of thumb, spend enough to generate 5–7 impressions per week per person in your retargeting audience without exceeding your frequency cap. For a site with 2,000 monthly visitors, $500–700 per month is typically enough to maintain consistent visibility without frequency fatigue. Retargeting spend should be proportional to site traffic — as traffic grows, retargeting budget can scale. Spending $2,000 per month on retargeting when you have 500 monthly visitors will just irritate the same small pool of people. Grow organic or paid acquisition first, then scale retargeting in proportion."
---
...
[See how RightAd works](https://www.rightsuite.co/products/right-ad?utm_source=docs&utm_medium=referral&utm_campaign=docs&utm_content=guide-retargeting-ads-saas){: .btn .btn-green }

---

**Related reading:**
- [RightAd — paid ad attribution and optimization]({{ '/docs/products/right-ad/' | relative_url }})
- [How to test ad creative before spending](/guides/test-ad-creative-before-spending/)
