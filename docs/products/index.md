...
<table style="font-family:'DM Mono',monospace;font-size:0.8125rem;min-width:600px;">
  <tr>
    <td style="padding:8px 16px 4px;color:#0d9488;font-weight:600;">Step 1</td>
    <td style="padding:8px 16px 4px;color:#0d9488;font-weight:600;">Step 2</td>
    <td style="padding:8px 16px 4px;color:#0d9488;font-weight:600;">Step 3</td>
    <td style="padding:8px 16px 4px;color:#0d9488;font-weight:600;">Step 4</td>
  </tr>
  <tr>
    <td style="padding:4px 16px 4px;color:#18181b;font-weight:500;">RightAudience</td>
    <td style="padding:4px 16px 4px;color:#18181b;font-weight:500;">RightPositioning</td>
    <td style="padding:4px 16px 4px;color:#18181b;font-weight:500;">RightPrice</td>
    <td style="padding:4px 16px 4px;color:#18181b;font-weight:500;">RightMessaging</td>
  </tr>
  <tr>
    <td style="padding:4px 16px 12px;color:#a3a3a3;font-size:0.75rem;">Find your segment</td>
    <td style="padding:4px 16px 12px;color:#a3a3a3;font-size:0.75rem;">Win the comparison</td>
    <td style="padding:4px 16px 12px;color:#a3a3a3;font-size:0.75rem;">Set the right price</td>
    <td style="padding:4px 16px 12px;color:#a3a3a3;font-size:0.75rem;">Write copy that converts</td>
  </tr>
  <tr>
    <td style="padding:8px 16px 4px;color:#0d9488;font-weight:600;">Step 5</td>
    <td style="padding:8px 16px 4px;color:#0d9488;font-weight:600;">Step 6</td>
    <td style="padding:8px 16px 4px;color:#0d9488;font-weight:600;">Step 7</td>
    <td></td>
  </tr>
  <tr>
    <td style="padding:4px 16px 4px;color:#18181b;font-weight:500;">RightEngagement</td>
    <td style="padding:4px 16px 4px;color:#18181b;font-weight:500;">RightChannel</td>
    <td style="padding:4px 16px 4px;color:#18181b;font-weight:500;">RightAd</td>
    <td></td>
  </tr>
  <tr>
    <td style="padding:4px 16px 12px;color:#a3a3a3;font-size:0.75rem;">Test cold outreach</td>
    <td style="padding:4px 16px 12px;color:#a3a3a3;font-size:0.75rem;">Find the right channel</td>
    <td style="padding:4px 16px 12px;color:#a3a3a3;font-size:0.75rem;">Test paid creative</td>
    <td></td>
  </tr>
</table>
</div>
...
<table>
  <tr>
    <td width="50%"><img src="{{ '/assets/before-audience.svg' | relative_url }}" alt="Before RightAudience" width="100%" /></td>
    <td width="50%"><img src="{{ '/assets/after-audience.svg' | relative_url }}" alt="After RightAudience" width="100%" /></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="{{ '/assets/before-positioning.svg' | relative_url }}" alt="Before RightPositioning" width="100%" /></td>
    <td width="50%"><img src="{{ '/assets/after-positioning.svg' | relative_url }}" alt="After RightPositioning" width="100%" /></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="{{ '/assets/before-pricing.svg' | relative_url }}" alt="Before RightPrice" width="100%" /></td>
    <td width="50%"><img src="{{ '/assets/after-pricing.svg' | relative_url }}" alt="After RightPrice" width="100%" /></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="{{ '/assets/before-messaging.svg' | relative_url }}" alt="Before RightMessaging" width="100%" /></td>
    <td width="50%"><img src="{{ '/assets/after-messaging.svg' | relative_url }}" alt="After RightMessaging" width="100%" /></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="{{ '/assets/before-engagement.svg' | relative_url }}" alt="Before RightEngagement" width="100%" /></td>
    <td width="50%"><img src="{{ '/assets/after-engagement.svg' | relative_url }}" alt="After RightEngagement" width="100%" /></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="{{ '/assets/before-outreach.svg' | relative_url }}" alt="Before RightChannel" width="100%" /></td>
    <td width="50%"><img src="{{ '/assets/after-outreach.svg' | relative_url }}" alt="After RightChannel" width="100%" /></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="{{ '/assets/before-ad.svg' | relative_url }}" alt="Before RightAd" width="100%" /></td>
    <td width="50%"><img src="{{ '/assets/after-ad.svg' | relative_url }}" alt="After RightAd" width="100%" /></td>
  </tr>
</table>
