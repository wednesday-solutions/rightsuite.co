...
Most founders pick an ICP based on who they know, who replied to their first outreach, or who they assumed the product was for. The assumption feels reasonable. Then the deal cycle is too long, the churn is too high, and the referrals don't come.

The segment with the highest purchase intent is often not the one you started with.

Selling to the wrong segment wastes sales cycles, inflates churn, and distorts your roadmap. You build features for customers who were never going to renew. You write copy for a persona that wasn't going to buy. Every downstream decision compounds in the wrong direction.
...
Share what you're building, the problem it solves, and the 2-4 segments you're considering. You don't need polished copy - rough descriptions work.
...
You can run any product without RightAudience - but the results sharpen once you know your segment.

---

## Boundaries

- **RightAudience vs. RightPositioning** - RightAudience tells you who to sell to. RightPositioning tells you how to win the comparison against competitors for that segment.
- **RightAudience vs. RightMessaging** - RightAudience ranks segments by purchase intent. RightMessaging tests whether your copy converts that segment.
- **RightAudience vs. RightChannel** - RightAudience identifies who your buyers are. RightChannel tells you where to reach them.
...
Live - [www.rightsuite.co/products/right-audience](https://www.rightsuite.co/products/right-audience?utm_source=docs&utm_medium=referral&utm_campaign=docs&utm_content=productdoc-right-audience)
